...
type SyncEntityType = "users" | "requests" | "inventory" | "home" | "fabAcademy" | "fabInterns" | "machines" | "settings";
...
function buildAppsScriptPayload(job: {
  ...
  const actionMap: Record<`${SyncEntityType}:${SyncOperation}`, string> = {
    ...
    "fabInterns:upsert": "upsertFabInternRow",
    "fabInterns:delete": "deleteFabInternRow",
    "machines:upsert": "upsertMachineRow",
    "machines:delete": "deleteMachineRow",
